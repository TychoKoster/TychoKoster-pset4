package koster.tychokoster_pset4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getList();
        listViewListener();
        /* This will add the first three contents in the item list when first opened. */
        if(adapter.getCount() == 0){
            dbManager.insert("Type in your item below");
            dbManager.insert("Press add to in add item in to do list");
            dbManager.insert("Hold item to remove from to do list");
